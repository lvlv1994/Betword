			...
			lv.setOnItemClickListener(new OnItemClickListener(){
				...
				public void onItemClick(AdapterView<?> arg0, View arg1,
					...
					if(wordlist.get(arg2).getLearned().equals("0")){
						Dialog dialog = new AlertDialog.Builder(ReviewMain.this)
			            .setTitle("提醒")
			            .setMessage("这个单元(LIST-"+(arg2+1)+")还没有学习过，要现在学习么")
			            .setPositiveButton("要学！", new DialogInterface.OnClickListener() {
						...
						Dialog dialog = new AlertDialog.Builder(ReviewMain.this)
			            .setTitle("提醒")
			            .setMessage("这个单元(LIST-"+(arg2+1)+")暂时不需要复习，确定现在复习吗")
